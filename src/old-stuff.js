export function old (d3, svg, imgSize) {
...
//const t = svg.transition().delay(500).duration(2000).ease(d3.easeElasticOut.amplitude(1).period(0.4))
const t = svg.transition().delay(300).duration(3500)
